...
if [ $ARCH = s390x -o $ARCH = ppc64le ]; then
    ...
    ESUM_s390x="5086a317a2fe0a42b1ea9a559dc87a5a349b25f1debcd109777acb7fa7349b20"
    ESUM_ppc64le="c52b806779e0c7cc432cea225d4c26e8c3a2d39f6b8535263cc44ea127f7f786"
