...
cd /w/workspace/fabric-baseimage-verify-x86_64/gopath/src/github.com/hyperledger
git clone --single-branch -b $GERRIT_BRANCH --depth 2 https://github.com/hyperledger/fabric-samples
